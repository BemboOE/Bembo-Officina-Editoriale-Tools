# 5. Istruzioni per la consegna degli elaborati 
...
### 5.4.2 Checklist invio materiali:

<table style="font-size:x-small">
	<thead>
		<tr>
			<th colspan=3><b>Documento / parte</b></th>
			<th colspan=2><b>Formato e requisiti</b></th>
			<th colspan=2><b>Denominazione file</b></th>
			<th colspan=5><b>Note</b></th>
       </tr>
	</thead>
	<tbody style="font-size:x-small; vertical-align: top;">
		<tr>
			<td colspan=3>* Liberatoria per pubblicazione Open Access</td>
			<td colspan=2>pdf</td>
